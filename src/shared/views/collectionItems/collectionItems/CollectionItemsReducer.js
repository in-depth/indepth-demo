...
const collectionItemState = {
  collectionItems: {
    HNT3APBUNY: {
      ...
      assets: {
        deepzoom: ['/static/images/collection-items/someplace.dzi'],
    ...
    APYPEBMF6X: {
      ...
      assets: {
        deepzoom: ['/static/images/collection-items/portrait-of-paul-hugot.dzi'],
    ...
    CWVSA3MEVN: {
      ...
      assets: {
        deepzoom: ['/static/images/collection-items/dino.dzi'],
